...
camera = new PerspectiveCamera( 3, window.innerWidth / window.innerHeight, 0.1, 1000 );
...
light = new DirectionalLight( "#FF1493", 3 );
...
let texturePass = new TexturePass(new TextureLoader().load("assets/icon.png"), 0.1);
